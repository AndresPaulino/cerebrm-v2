...
class Client:
    ...
    def __init__(self, user_id, app_key, app_secret, callback_url="https://127.0.0.1", timeout=5, verbose=False, update_tokens_auto=True):
        """
        ...
        self.tokens = Tokens(user_id, app_key, app_secret, callback_url, update_tokens_auto=update_tokens_auto)
